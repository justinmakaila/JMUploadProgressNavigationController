Pod::Spec.new do |s|
  ...
  s.platform     = :ios, '7.0'
  s.source       = { :git => "https://github.com/justinmakaila/JMUploadProgressNavigationController.git", :commit => "967c5bf9c475e9cc27dd8fee5e922f2c22fcd4cd" }
  s.source_files = 'Classes', 'JMUploadProgressNavigationController/**/*.{h,m}'
